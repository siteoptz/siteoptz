...
const seoComponents: Record<string, () => Promise<{ default: ComponentType<SEOComponentProps> }>> = {
  ...
  '10web': () => import('../seo-optimization/production-components/Tool10webReviewPage'),
  ...
  'speechki-text-to-speech-ai': () => import('../seo-optimization/production-components/SpeechkiTexttospeechAiReviewPage'),
  ...
  'unreal-speech-cost-effective-text-to-speech-api': () => import('../seo-optimization/production-components/UnrealSpeechCosteffectiveTexttospeechApiReviewPage'),
