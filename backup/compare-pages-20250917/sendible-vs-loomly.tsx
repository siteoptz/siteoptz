...
export default function SendibleVsLoomly({ tool1, tool2 }: ComparisonPageProps) {
  ...
  return {
    props: {
      tool1: {
        ...
        description: "Agency-focused social media tool with white-label options and comprehensive publishing capabilities."
      },
      tool2: {
        name: "Loomly",
        slug: "loomly",
