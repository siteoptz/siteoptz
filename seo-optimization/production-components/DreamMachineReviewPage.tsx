...
export default function DreamMachineReviewPage({ tool }: DreamMachineReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Dream Machine Review: AI Video Creation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Dream Machine Review: AI Video Creation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Dream Machine Review: AI Video Creation Tool | SiteOptz" />
