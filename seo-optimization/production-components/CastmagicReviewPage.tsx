...
export default function CastmagicReviewPage({ tool }: CastmagicReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Castmagic Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Castmagic Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Castmagic Review: AI Content Creation Platform | SiteOptz" />
