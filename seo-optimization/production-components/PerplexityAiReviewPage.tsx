...
export default function PerplexityAiReviewPage({ tool }: PerplexityAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Perplexity AI Review: AI Research Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Perplexity AI Review: AI Research Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Perplexity AI Review: AI Research Assistant | SiteOptz" />
