...
export default function PerplexityAiReviewPage({ tool }: PerplexityAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Perplexity AI Review: AI Search Engine | SiteOptz</title>
        <meta name="description" content="Perplexity AI Review 2025: AI-powered search engine providing accurate answers with source citations and real-time information. Advanced reasoning capabilities. Compare pricing, features & alternatives." />
        ...
        <meta property="og:title" content="Perplexity AI Review: AI Search Engine | SiteOptz" />
        ...
        <meta name="twitter:title" content="Perplexity AI Review: AI Search Engine | SiteOptz" />
...
<Link href="/compare"
      ...
      <a href="#perplexity-ai-key-features-capabilities" className="block text-cyan-400 hover:underline text-sm">
        → Key Features
      </a>
      <a href="#perplexity-ai-pricing-plans-value-analysis" className="block text-cyan-400 hover:underline text-sm">
        → Pricing Plans
      </a>
      <a href="#real-world-perplexity-ai-use-cases-applications" className="block text-cyan-400 hover:underline text-sm">
        → Use Cases
      </a>
      <a href="#perplexity-ai-pros-and-cons-honest-assessment" className="block text-cyan-400 hover:underline text-sm">
        → Pros & Cons
      </a>
        ...
        <section className="relative z-10 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Link href="/compare/perplexity-ai/vs/consensus" className="group">
                <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-gray-600 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400">
                    Perplexity AI vs Consensus
                  </h3>
                  <p className="text-gray-300">Side-by-side comparison of features and pricing</p>
                </div>
              </Link>
              <Link href="/compare/perplexity-ai/vs/elicit" className="group">
                <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-gray-600 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400">
                    Perplexity AI vs Elicit
                  </h3>
                  <p className="text-gray-300">Side-by-side comparison of features and pricing</p>
                </div>
              </Link>
              <Link href="/compare/perplexity-ai/vs/scite-ai" className="group">
                <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-gray-600 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400">
                    Perplexity AI vs Scite Ai
                  </h3>
                  <p className="text-gray-300">Side-by-side comparison of features and pricing</p>
                </div>
              </Link>
