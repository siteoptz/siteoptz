...
export default function PaperpalReviewPage({ tool }: PaperpalReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Paperpal Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Paperpal Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Paperpal Review: AI Content Creation Platform | SiteOptz" />
