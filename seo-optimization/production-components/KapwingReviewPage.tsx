...
export default function KapwingReviewPage({ tool }: KapwingReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Kapwing Review: AI Video Creation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Kapwing Review: AI Video Creation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Kapwing Review: AI Video Creation Tool | SiteOptz" />
