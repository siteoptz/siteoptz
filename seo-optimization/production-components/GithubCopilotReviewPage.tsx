...
export default function GithubCopilotReviewPage({ tool }: GithubCopilotReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>GitHub Copilot Review: AI Code Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="GitHub Copilot Review: AI Code Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="GitHub Copilot Review: AI Code Assistant | SiteOptz" />
