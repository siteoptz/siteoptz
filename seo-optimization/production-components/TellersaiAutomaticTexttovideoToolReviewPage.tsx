...
const TellersaiAutomaticTexttovideoToolReviewPage: React.FC<TellersaiAutomaticTexttovideoToolReviewPageProps> = ({ tool }) => {
...
export default TellersaiAutomaticTexttovideoToolReviewPage;
