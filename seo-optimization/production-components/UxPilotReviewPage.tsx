...
export default function UxPilotReviewPage({ tool }: UxPilotReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>UX Pilot Review: AI Website Builder | SiteOptz</title>
        ...
        <meta property="og:title" content="UX Pilot Review: AI Website Builder | SiteOptz" />
        ...
        <meta name="twitter:title" content="UX Pilot Review: AI Website Builder | SiteOptz" />
