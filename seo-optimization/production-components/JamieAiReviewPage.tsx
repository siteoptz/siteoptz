...
export default function JamieAiReviewPage({ tool }: JamieAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Jamie AI Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Jamie AI Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Jamie AI Review: AI Productivity Assistant | SiteOptz" />
