...
export default function AdzoomaReviewPage({ tool }: AdzoomaReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Adzooma Review: AI PPC Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Adzooma Review: AI PPC Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Adzooma Review: AI PPC Management Tool | SiteOptz" />
