...
export default function OpenaiGpt4ReviewPage({ tool }: OpenaiGpt4ReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>GPT-4 Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="GPT-4 Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="GPT-4 Review: AI Content Creation Platform | SiteOptz" />
