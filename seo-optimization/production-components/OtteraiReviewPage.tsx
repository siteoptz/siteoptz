...
export default function OtteraiReviewPage({ tool }: OtteraiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Otter.ai Review: AI Voice Technology | SiteOptz</title>
        ...
        <meta property="og:title" content="Otter.ai Review: AI Voice Technology | SiteOptz" />
        ...
        <meta name="twitter:title" content="Otter.ai Review: AI Voice Technology | SiteOptz" />
