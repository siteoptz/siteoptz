...
export default function AiropsReviewPage({ tool }: AiropsReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>AirOps Review: AI SEO Optimization Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="AirOps Review: AI SEO Optimization Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="AirOps Review: AI SEO Optimization Tool | SiteOptz" />
