...
export default function GwiReviewPage({ tool }: GwiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>GWI Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="GWI Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="GWI Review: AI Content Creation Platform | SiteOptz" />
