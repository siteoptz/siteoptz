...
export default function FirefliesReviewPage({ tool }: FirefliesReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Fireflies Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Fireflies Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Fireflies Review: AI Workflow Automation Tool | SiteOptz" />
