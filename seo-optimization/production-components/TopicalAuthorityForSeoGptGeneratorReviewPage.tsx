...
const TopicalAuthorityForSeoGptGeneratorReviewPage: React.FC<TopicalAuthorityForSeoGptGeneratorReviewPageProps> = ({ tool }) => {
...
export default TopicalAuthorityForSeoGptGeneratorReviewPage;
