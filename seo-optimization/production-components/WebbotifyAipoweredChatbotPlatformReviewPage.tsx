...
const WebbotifyAipoweredChatbotPlatformReviewPage: React.FC<WebbotifyAipoweredChatbotPlatformReviewPageProps> = ({ tool }) => {
...
export default WebbotifyAipoweredChatbotPlatformReviewPage;
