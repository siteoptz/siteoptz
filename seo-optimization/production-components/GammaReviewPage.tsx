...
export default function GammaReviewPage({ tool }: GammaReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Gamma Review: AI Social Media Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Gamma Review: AI Social Media Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Gamma Review: AI Social Media Management Tool | SiteOptz" />
