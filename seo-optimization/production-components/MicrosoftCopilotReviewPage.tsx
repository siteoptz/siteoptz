...
export default function MicrosoftCopilotReviewPage({ tool }: MicrosoftCopilotReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Microsoft Copilot Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Microsoft Copilot Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Microsoft Copilot Review: AI Productivity Assistant | SiteOptz" />
