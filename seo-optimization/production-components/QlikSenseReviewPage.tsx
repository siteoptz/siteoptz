...
export default function QlikSenseReviewPage({ tool }: QlikSenseReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Qlik Sense Review: AI Data Analytics Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Qlik Sense Review: AI Data Analytics Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Qlik Sense Review: AI Data Analytics Platform | SiteOptz" />
