...
export default function LtxStudioReviewPage({ tool }: LtxStudioReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>LTX Studio Review: AI Video Creation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="LTX Studio Review: AI Video Creation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="LTX Studio Review: AI Video Creation Tool | SiteOptz" />
