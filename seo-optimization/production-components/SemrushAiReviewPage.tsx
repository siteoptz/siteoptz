...
export default function SemrushAiReviewPage({ tool }: SemrushAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Semrush AI Review: AI SEO Optimization Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Semrush AI Review: AI SEO Optimization Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Semrush AI Review: AI SEO Optimization Tool | SiteOptz" />
