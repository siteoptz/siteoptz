                ...
                <div className="bg-black border border-gray-800 backdrop-blur-md rounded-2xl p-6 sticky top-8">
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-800">
                    ...
                    <nav className="space-y-2">
                      <a href="#anthropic-claude-key-features-capabilities" className="block text-cyan-400 hover:underline text-sm">
                        → Key Features
                      </a>
                      <a href="#anthropic-claude-pricing-plans-value-analysis" className="block text-cyan-400 hover:underline text-sm">
                        → Pricing Plans
                      </a>
                      <a href="#real-world-anthropic-claude-use-cases-applications" className="block text-cyan-400 hover:underline text-sm">
                        → Use Cases
                      </a>
                      <a href="#anthropic-claude-pros-and-cons-honest-assessment" className="block text-cyan-400 hover:underline text-sm">
                        → Pros & Cons
                      </a>
        ...
        <section className="relative z-10 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Link href="/compare/anthropic-claude/vs/jasper-ai" className="group">
                <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-gray-600 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400">
                    Anthropic Claude vs Jasper Ai
                  </h3>
                  <p className="text-gray-300">Side-by-side comparison of features and pricing</p>
                </div>
              </Link>
              <Link href="/compare/anthropic-claude/vs/writesonic" className="group">
                <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-gray-600 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400">
                    Anthropic Claude vs Writesonic
                  </h3>
                  <p className="text-gray-300">Side-by-side comparison of features and pricing</p>
                </div>
              </Link>
              <Link href="/compare/anthropic-claude/vs/copy-ai" className="group">
                <div className="bg-black border border-gray-800 rounded-xl p-6 hover:border-gray-600 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400">
                    Anthropic Claude vs Copy Ai
                  </h3>
                  <p className="text-gray-300">Side-by-side comparison of features and pricing</p>
                </div>
              </Link>
