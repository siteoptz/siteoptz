...
export default function OptmyzrReviewPage({ tool }: OptmyzrReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Optmyzr Review: AI PPC Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Optmyzr Review: AI PPC Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Optmyzr Review: AI PPC Management Tool | SiteOptz" />
