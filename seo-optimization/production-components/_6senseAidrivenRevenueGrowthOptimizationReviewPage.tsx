...
interface _6senseAidrivenRevenueGrowthOptimizationReviewPageProps {
  tool: {
    name: string;
    category: string;
    description: string;
...
const _6senseAidrivenRevenueGrowthOptimizationReviewPage: React.FC<_6senseAidrivenRevenueGrowthOptimizationReviewPageProps> = ({ tool }) => {
...
export default _6senseAidrivenRevenueGrowthOptimizationReviewPage;
