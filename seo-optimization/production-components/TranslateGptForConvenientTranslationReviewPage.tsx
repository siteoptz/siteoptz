...
const TranslateGptForConvenientTranslationReviewPage: React.FC<TranslateGptForConvenientTranslationReviewPageProps> = ({ tool }) => {
...
export default TranslateGptForConvenientTranslationReviewPage;
