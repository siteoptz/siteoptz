...
export default function CohereAiReviewPage({ tool }: CohereAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Cohere Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Cohere Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Cohere Review: AI Content Creation Platform | SiteOptz" />
