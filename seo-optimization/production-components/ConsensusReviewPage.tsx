...
export default function ConsensusReviewPage({ tool }: ConsensusReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Consensus Review: AI Research Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Consensus Review: AI Research Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Consensus Review: AI Research Assistant | SiteOptz" />
