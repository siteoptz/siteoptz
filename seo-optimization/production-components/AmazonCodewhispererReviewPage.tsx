...
export default function AmazonCodewhispererReviewPage({ tool }: AmazonCodewhispererReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Amazon CodeWhisperer Review: AI Code Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Amazon CodeWhisperer Review: AI Code Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Amazon CodeWhisperer Review: AI Code Assistant | SiteOptz" />
