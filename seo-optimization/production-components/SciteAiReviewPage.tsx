  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="scite.ai Review: Citation Analysis Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="scite.ai Review: Citation Analysis Platform | SiteOptz" />
...
<Link href="/compare"
      ...
      <a href="#scite-ai-key-features-capabilities" className="block text-cyan-400 hover:underline text-sm">
        → Key Features
      </a>
      <a href="#scite-ai-pricing-plans-value-analysis" className="block text-cyan-400 hover:underline text-sm">
        → Pricing Plans
      </a>
      <a href="#real-world-scite-ai-use-cases-applications" className="block text-cyan-400 hover:underline text-sm">
        → Use Cases
      </a>
      <a href="#scite-ai-pros-and-cons-honest-assessment" className="block text-cyan-400 hover:underline text-sm">
        → Pros & Cons
      </a>
