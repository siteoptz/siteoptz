...
const ConvertfilesaiFreeImageFileConverterReviewPage: React.FC<ConvertfilesaiFreeImageFileConverterReviewPageProps> = ({ tool }) => {
...
export default ConvertfilesaiFreeImageFileConverterReviewPage;
