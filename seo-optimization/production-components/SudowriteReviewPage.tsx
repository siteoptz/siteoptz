...
export default function SudowriteReviewPage({ tool }: SudowriteReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Sudowrite Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Sudowrite Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Sudowrite Review: AI Content Creation Platform | SiteOptz" />
