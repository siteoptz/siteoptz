...
export default function PpcIoReviewPage({ tool }: PpcIoReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>PPC IO Review: AI PPC Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="PPC IO Review: AI PPC Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="PPC IO Review: AI PPC Management Tool | SiteOptz" />
