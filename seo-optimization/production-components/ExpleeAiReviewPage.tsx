...
export default function ExpleeAiReviewPage({ tool }: ExpleeAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Explee Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Explee Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Explee Review: AI Productivity Assistant | SiteOptz" />
