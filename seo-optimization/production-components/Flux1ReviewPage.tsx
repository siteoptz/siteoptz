...
export default function Flux1ReviewPage({ tool }: Flux1ReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Flux 1 Review: AI-Powered Solution | SiteOptz</title>
        ...
        <meta property="og:title" content="Flux 1 Review: AI-Powered Solution | SiteOptz" />
        ...
        <meta name="twitter:title" content="Flux 1 Review: AI-Powered Solution | SiteOptz" />
