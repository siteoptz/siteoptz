...
export default function ReplicateAiReviewPage({ tool }: ReplicateAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Replicate Review: AI Code Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Replicate Review: AI Code Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Replicate Review: AI Code Assistant | SiteOptz" />
