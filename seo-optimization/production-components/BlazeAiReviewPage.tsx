...
export default function BlazeAiReviewPage({ tool }: BlazeAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Blaze AI Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Blaze AI Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Blaze AI Review: AI Content Creation Platform | SiteOptz" />
