...
export default function AhrefsAiReviewPage({ tool }: AhrefsAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Ahrefs AI Review: AI SEO Optimization Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Ahrefs AI Review: AI SEO Optimization Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Ahrefs AI Review: AI SEO Optimization Tool | SiteOptz" />
