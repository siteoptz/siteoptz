...
export default function MacaronAiReviewPage({ tool }: MacaronAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Macaron AI Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Macaron AI Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Macaron AI Review: AI Workflow Automation Tool | SiteOptz" />
