...
export default function TraceAiReviewPage({ tool }: TraceAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Trace AI Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Trace AI Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Trace AI Review: AI Productivity Assistant | SiteOptz" />
