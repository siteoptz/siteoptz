...
const BottrYourPersonalAiAssistantReviewPage: React.FC<BottrYourPersonalAiAssistantReviewPageProps> = ({ tool }) => {
...
export default BottrYourPersonalAiAssistantReviewPage;
