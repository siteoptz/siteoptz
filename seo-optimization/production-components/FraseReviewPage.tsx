...
export default function FraseReviewPage({ tool }: FraseReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Frase Review: AI SEO Optimization Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Frase Review: AI SEO Optimization Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Frase Review: AI SEO Optimization Tool | SiteOptz" />
