...
const DivedeckAipoweredDeckBuilderReviewPage: React.FC<DivedeckAipoweredDeckBuilderReviewPageProps> = ({ tool }) => {
...
export default DivedeckAipoweredDeckBuilderReviewPage;
