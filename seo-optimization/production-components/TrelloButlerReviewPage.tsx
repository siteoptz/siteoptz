...
export default function TrelloButlerReviewPage({ tool }: TrelloButlerReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Trello Butler Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Trello Butler Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Trello Butler Review: AI Productivity Assistant | SiteOptz" />
