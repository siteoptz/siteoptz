...
export default function SunoReviewPage({ tool }: SunoReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Suno Review: AI Content Creation Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Suno Review: AI Content Creation Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Suno Review: AI Content Creation Platform | SiteOptz" />
