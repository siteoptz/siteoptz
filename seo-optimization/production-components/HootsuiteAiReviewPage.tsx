...
export default function HootsuiteAiReviewPage({ tool }: HootsuiteAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Hootsuite AI Review: AI Social Media Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Hootsuite AI Review: AI Social Media Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Hootsuite AI Review: AI Social Media Management Tool | SiteOptz" />
