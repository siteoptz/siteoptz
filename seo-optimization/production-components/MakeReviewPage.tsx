...
export default function MakeReviewPage({ tool }: MakeReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Make Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Make Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Make Review: AI Workflow Automation Tool | SiteOptz" />
