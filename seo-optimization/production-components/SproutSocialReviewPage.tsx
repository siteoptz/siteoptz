...
export default function SproutSocialReviewPage({ tool }: SproutSocialReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Sprout Social Review: AI Social Media Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Sprout Social Review: AI Social Media Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Sprout Social Review: AI Social Media Management Tool | SiteOptz" />
