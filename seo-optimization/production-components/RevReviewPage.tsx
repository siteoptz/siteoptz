...
export default function RevReviewPage({ tool }: RevReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Rev Review: AI Voice Technology | SiteOptz</title>
        ...
        <meta property="og:title" content="Rev Review: AI Voice Technology | SiteOptz" />
        ...
        <meta name="twitter:title" content="Rev Review: AI Voice Technology | SiteOptz" />
