...
export default function MicrosoftPowerpointReviewPage({ tool }: MicrosoftPowerpointReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Microsoft PowerPoint Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Microsoft PowerPoint Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Microsoft PowerPoint Review: AI Productivity Assistant | SiteOptz" />
