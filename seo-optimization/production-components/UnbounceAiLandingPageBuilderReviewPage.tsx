...
const UnbounceAiLandingPageBuilderReviewPage: React.FC<UnbounceAiLandingPageBuilderReviewPageProps> = ({ tool }) => {
...
export default UnbounceAiLandingPageBuilderReviewPage;
