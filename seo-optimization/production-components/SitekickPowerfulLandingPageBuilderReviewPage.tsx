...
const SitekickPowerfulLandingPageBuilderReviewPage: React.FC<SitekickPowerfulLandingPageBuilderReviewPageProps> = ({ tool }) => {
...
export default SitekickPowerfulLandingPageBuilderReviewPage;
