...
export default function ApifyReviewPage({ tool }: ApifyReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Apify Review: AI PPC Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Apify Review: AI PPC Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Apify Review: AI PPC Management Tool | SiteOptz" />
