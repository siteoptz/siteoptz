...
export default function ShortwaveReviewPage({ tool }: ShortwaveReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Shortwave Review: AI Email Marketing Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Shortwave Review: AI Email Marketing Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Shortwave Review: AI Email Marketing Tool | SiteOptz" />
