...
export default function AmazonAlexaReviewPage({ tool }: AmazonAlexaReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Amazon Alexa Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Amazon Alexa Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Amazon Alexa Review: AI Workflow Automation Tool | SiteOptz" />
