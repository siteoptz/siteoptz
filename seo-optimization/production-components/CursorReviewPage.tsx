...
export default function CursorReviewPage({ tool }: CursorReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Cursor Review: AI Code Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Cursor Review: AI Code Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Cursor Review: AI Code Assistant | SiteOptz" />
