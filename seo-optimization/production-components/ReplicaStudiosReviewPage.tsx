...
export default function ReplicaStudiosReviewPage({ tool }: ReplicaStudiosReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Replica Studios Review: AI Voice Technology | SiteOptz</title>
        ...
        <meta property="og:title" content="Replica Studios Review: AI Voice Technology | SiteOptz" />
        ...
        <meta name="twitter:title" content="Replica Studios Review: AI Voice Technology | SiteOptz" />
