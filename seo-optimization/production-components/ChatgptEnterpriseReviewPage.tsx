...
export default function ChatgptEnterpriseReviewPage({ tool }: ChatgptEnterpriseReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>ChatGPT Enterprise Review: AI Data Analytics Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="ChatGPT Enterprise Review: AI Data Analytics Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="ChatGPT Enterprise Review: AI Data Analytics Platform | SiteOptz" />
