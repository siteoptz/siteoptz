...
<p className="text-gray-300 mb-4">A 15-person marketing agency implemented ChatGPT Enterprise to manage client campaigns. Results included 40% faster project completion and improved client satisfaction scores.</p><p className="text-gray-300 mb-4"><strong className="text-white">Case Study 2 - Enterprise:</strong></p>
