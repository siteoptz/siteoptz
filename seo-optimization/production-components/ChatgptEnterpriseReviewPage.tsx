...
<Link href="https://openai.com/enterprise"
                    target="_blank"
...
<Link href="/compare"
      ...
      <a href="#chatgpt-enterprise-key-features-capabilities" className="block text-cyan-400 hover:underline text-sm">
        → Key Features
      </a>
      <a href="#chatgpt-enterprise-pricing-plans-value-analysis" className="block text-cyan-400 hover:underline text-sm">
        → Pricing Plans
      </a>
      <a href="#real-world-chatgpt-enterprise-use-cases-applications" className="block text-cyan-400 hover:underline text-sm">
        → Use Cases
      </a>
      <a href="#chatgpt-enterprise-pros-and-cons-honest-assessment" className="block text-cyan-400 hover:underline text-sm">
        → Pros & Cons
      </a>
