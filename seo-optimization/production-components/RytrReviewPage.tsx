...
export default function RytrReviewPage({ tool }: RytrReviewPageProps) {
  ...
  const reviewSchema = {
    ...
    "reviewBody": "Expert review of Rytr covering Content Creation features, pricing analysis, user experience, and competitive alternatives. Rytr stands out with its 4.Highly rated rating, offering robust content creation capabilities that scale with your business."
  };
              ...
              <div className="lg:w-2/3">
                ...
                <div className="prose prose-lg prose-invert max-w-none mb-10">
                  <div className="text-xl text-blue-100 leading-relaxed space-y-4">
                    ...
                    <p className="mb-4">Rytr is an AI writing assistant designed for short-form content creation, accessible across various platforms. It helps users generate original and compelling content quickly, offering over 40 use cases and templates, including blog posts, social media ads, email responses, and more. Rytr aims to sound like the user, not a robot, by analyzing writing samples and mirroring tone, with options for custom tones. It also emphasizes plagiarism-free content and offers a Chrome Extension for seamless integration into writing workflows. Key capabilities include ai-powered content generation, over 40 content use cases and templates, supports 20+ tones of voice, making it an essential tool for Content Creation. Understanding these capabilities is essential for evaluating whether Rytr aligns with your specific requirements.</p>
                    <p className="mb-4">In this comprehensive rytr review, we examine its Content Creation capabilities, pricing model, and real-world applications. Rytr stands out with its 4.9/5 rating, offering robust content creation capabilities that scale with your business. Our detailed analysis provides the insights you need to make an informed decision about whether Rytr fits your workflow.</p>
