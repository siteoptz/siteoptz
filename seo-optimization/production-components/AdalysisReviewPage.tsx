...
export default function AdalysisReviewPage({ tool }: AdalysisReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Adalysis Review: AI PPC Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Adalysis Review: AI PPC Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Adalysis Review: AI PPC Management Tool | SiteOptz" />
