...
export default function GongIoReviewPage({ tool }: GongIoReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>GONG IO Review: AI PPC Management Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="GONG IO Review: AI PPC Management Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="GONG IO Review: AI PPC Management Tool | SiteOptz" />
