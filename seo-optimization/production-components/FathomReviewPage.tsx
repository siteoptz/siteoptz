...
export default function FathomReviewPage({ tool }: FathomReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Fathom Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Fathom Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Fathom Review: AI Productivity Assistant | SiteOptz" />
