...
export default function GumloopReviewPage({ tool }: GumloopReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Gumloop Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Gumloop Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Gumloop Review: AI Workflow Automation Tool | SiteOptz" />
