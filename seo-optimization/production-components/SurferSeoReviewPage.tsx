...
export default function SurferSeoReviewPage({ tool }: SurferSeoReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Surfer SEO Review: AI SEO Optimization Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Surfer SEO Review: AI SEO Optimization Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Surfer SEO Review: AI SEO Optimization Tool | SiteOptz" />
