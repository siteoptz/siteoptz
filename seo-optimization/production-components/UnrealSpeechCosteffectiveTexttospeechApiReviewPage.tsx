...
const UnrealSpeechCosteffectiveTexttospeechApiReviewPage: React.FC<UnrealSpeechCosteffectiveTexttospeechApiReviewPageProps> = ({ tool }) => {
...
export default UnrealSpeechCosteffectiveTexttospeechApiReviewPage;
