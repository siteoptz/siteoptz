...
export default function AdobeFireflyReviewPage({ tool }: AdobeFireflyReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Adobe Firefly Review: AI Image Generator | SiteOptz</title>
        ...
        <meta property="og:title" content="Adobe Firefly Review: AI Image Generator | SiteOptz" />
        ...
        <meta name="twitter:title" content="Adobe Firefly Review: AI Image Generator | SiteOptz" />
