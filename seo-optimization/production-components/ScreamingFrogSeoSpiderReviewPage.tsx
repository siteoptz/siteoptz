...
export default function ScreamingFrogSeoSpiderReviewPage({ tool }: ScreamingFrogSeoSpiderReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Screaming Frog SEO Spider Review: AI SEO Optimization Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Screaming Frog SEO Spider Review: AI SEO Optimization Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Screaming Frog SEO Spider Review: AI SEO Optimization Tool | SiteOptz" />
