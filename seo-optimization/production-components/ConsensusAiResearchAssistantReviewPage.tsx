...
const ConsensusAiResearchAssistantReviewPage: React.FC<ConsensusAiResearchAssistantReviewPageProps> = ({ tool }) => {
...
export default ConsensusAiResearchAssistantReviewPage;
