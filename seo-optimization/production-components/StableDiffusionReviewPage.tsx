...
export default function StableDiffusionReviewPage({ tool }: StableDiffusionReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Stable Diffusion Review: AI Image Generator | SiteOptz</title>
        ...
        <meta property="og:title" content="Stable Diffusion Review: AI Image Generator | SiteOptz" />
        ...
        <meta name="twitter:title" content="Stable Diffusion Review: AI Image Generator | SiteOptz" />
