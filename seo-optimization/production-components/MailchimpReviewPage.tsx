...
export default function MailchimpReviewPage({ tool }: MailchimpReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Mailchimp Review: AI Email Marketing Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Mailchimp Review: AI Email Marketing Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Mailchimp Review: AI Email Marketing Tool | SiteOptz" />
