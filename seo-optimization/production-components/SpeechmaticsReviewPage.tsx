...
export default function SpeechmaticsReviewPage({ tool }: SpeechmaticsReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Speechmatics Review: AI Voice Technology | SiteOptz</title>
        ...
        <meta property="og:title" content="Speechmatics Review: AI Voice Technology | SiteOptz" />
        ...
        <meta name="twitter:title" content="Speechmatics Review: AI Voice Technology | SiteOptz" />
