...
export default function GuruReviewPage({ tool }: GuruReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Guru Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Guru Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Guru Review: AI Productivity Assistant | SiteOptz" />
