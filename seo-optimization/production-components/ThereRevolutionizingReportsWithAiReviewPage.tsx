...
const ThereRevolutionizingReportsWithAiReviewPage: React.FC<ThereRevolutionizingReportsWithAiReviewPageProps> = ({ tool }) => {
...
export default ThereRevolutionizingReportsWithAiReviewPage;
