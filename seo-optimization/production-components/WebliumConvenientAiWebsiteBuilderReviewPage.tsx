...
const WebliumConvenientAiWebsiteBuilderReviewPage: React.FC<WebliumConvenientAiWebsiteBuilderReviewPageProps> = ({ tool }) => {
...
export default WebliumConvenientAiWebsiteBuilderReviewPage;
