...
export default function TableauAiReviewPage({ tool }: TableauAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Tableau AI Review: AI Data Analytics Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Tableau AI Review: AI Data Analytics Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Tableau AI Review: AI Data Analytics Platform | SiteOptz" />
