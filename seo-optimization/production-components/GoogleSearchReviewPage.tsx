...
export default function GoogleSearchReviewPage({ tool }: GoogleSearchReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Google Search Review: AI Productivity Assistant | SiteOptz</title>
        ...
        <meta property="og:title" content="Google Search Review: AI Productivity Assistant | SiteOptz" />
        ...
        <meta name="twitter:title" content="Google Search Review: AI Productivity Assistant | SiteOptz" />
