...
const OcoyaReviewPage: React.FC<OcoyaReviewPageProps> = () => {
  return (
    <>
      <Head>
        <title>Ocoya Review: Platform to create, auto-generate and schedule content quicker [2025] | SiteOptz</title>
        <meta 
          name="description" 
          content="Ocoya review. Platform to create, auto-generate and schedule content quicker. Content marketing, copywriting and social media in minutes.... Features, pricing & alternatives compared." 
        />
        <meta property="og:title" content="Ocoya Review: Platform to create, auto-generate and schedule content quicker [2025] | SiteOptz" />
        <meta property="og:description" content="Ocoya review. Platform to create, auto-generate and schedule content quicker. Content marketing, copywriting and social media in minutes.... Features, pricing & alternatives compared." />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "itemReviewed": {
                ...
                "operatingSystem": "Web",
                "description": "Platform to create, auto-generate and schedule content quicker. Content marketing, copywriting and social media in minutes."
              },
              "author": {
                "@type": "Organization",
                "name": "SiteOptz"
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="relative py-24 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold text-white mb-6">
              Ocoya Review: Social Media Analysis [2025]
            </h1>
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Platform to create, auto-generate and schedule content quicker. Content marketing, copywriting and social media in minutes.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-300">
                    ...
                    <p><strong>Developer:</strong> Ocoya</p>
                    <p><strong>Rating:</strong> 4.6/5 (91 reviews)</p>
                    <p><strong>Website:</strong> <a href="https://ocoya.com" className="text-blue-400 hover:text-blue-300">https://ocoya.com</a></p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="max-w-4xl mx-auto px-4">
            <div className="space-y-6">
              <div className="bg-gray-900 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-400 mb-3">
                  What is Ocoya best used for?
                </h3>
                <p className="text-gray-300">
                  Ocoya is primarily designed for social media tasks, offering social media scheduling and content calendar capabilities.
                </p>
              </div>
              ...
              <div className="bg-gray-900 rounded-lg p-6">
                ...
                <p className="text-gray-300">
                  Ocoya offers 3 pricing plans starting from $29/month.
                </p>
              </div>

              <div className="bg-gray-900 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-blue-400 mb-3">
                  Is Ocoya suitable for beginners?
                </h3>
                <p className="text-gray-300">
                  Ocoya is designed with user-friendliness in mind, making it accessible for both beginners and advanced users in the social media space.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center py-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Platform to create, auto-generate and schedule content quicker.
          </p>
          <a 
            href="https://ocoya.com"
            target="_blank"
...
export default OcoyaReviewPage;