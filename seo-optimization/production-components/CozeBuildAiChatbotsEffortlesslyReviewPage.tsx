...
const CozeBuildAiChatbotsEffortlesslyReviewPage: React.FC<CozeBuildAiChatbotsEffortlesslyReviewPageProps> = ({ tool }) => {
...
export default CozeBuildAiChatbotsEffortlesslyReviewPage;
