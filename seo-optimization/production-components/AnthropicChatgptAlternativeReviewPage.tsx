...
export default function AnthropicChatgptAlternativeReviewPage({ tool }: AnthropicChatgptAlternativeReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Character.AI Review: AI Image Generator | SiteOptz</title>
        ...
        <meta property="og:title" content="Character.AI Review: AI Image Generator | SiteOptz" />
        ...
        <meta name="twitter:title" content="Character.AI Review: AI Image Generator | SiteOptz" />
