...
const UniverseNocodeCustomWebsiteBuilderReviewPage: React.FC<UniverseNocodeCustomWebsiteBuilderReviewPageProps> = ({ tool }) => {
...
export default UniverseNocodeCustomWebsiteBuilderReviewPage;
