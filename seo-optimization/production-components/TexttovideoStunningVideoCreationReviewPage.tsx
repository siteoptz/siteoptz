...
const TexttovideoStunningVideoCreationReviewPage: React.FC<TexttovideoStunningVideoCreationReviewPageProps> = ({ tool }) => {
...
export default TexttovideoStunningVideoCreationReviewPage;
