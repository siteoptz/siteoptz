...
export default function ZapierAiReviewPage({ tool }: ZapierAiReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Zapier AI Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="Zapier AI Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="Zapier AI Review: AI Workflow Automation Tool | SiteOptz" />
