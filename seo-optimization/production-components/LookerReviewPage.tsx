...
export default function LookerReviewPage({ tool }: LookerReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Looker Review: AI Data Analytics Platform | SiteOptz</title>
        ...
        <meta property="og:title" content="Looker Review: AI Data Analytics Platform | SiteOptz" />
        ...
        <meta name="twitter:title" content="Looker Review: AI Data Analytics Platform | SiteOptz" />
