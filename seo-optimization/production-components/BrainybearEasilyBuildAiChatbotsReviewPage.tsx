...
const BrainybearEasilyBuildAiChatbotsReviewPage: React.FC<BrainybearEasilyBuildAiChatbotsReviewPageProps> = ({ tool }) => {
...
export default BrainybearEasilyBuildAiChatbotsReviewPage;
