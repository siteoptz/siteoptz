...
export default function ClickupReviewPage({ tool }: ClickupReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>ClickUp Review: AI Workflow Automation Tool | SiteOptz</title>
        ...
        <meta property="og:title" content="ClickUp Review: AI Workflow Automation Tool | SiteOptz" />
        ...
        <meta name="twitter:title" content="ClickUp Review: AI Workflow Automation Tool | SiteOptz" />
