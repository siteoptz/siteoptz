...
export default function StabilityAiStableDiffusionReviewPage({ tool }: StabilityAiStableDiffusionReviewPageProps) {
  ...
  return (
    <>
      <Head>
        {/* Primary SEO Tags */}
        <title>Stable Diffusion Web Review: AI Image Generator | SiteOptz</title>
        ...
        <meta property="og:title" content="Stable Diffusion Web Review: AI Image Generator | SiteOptz" />
        ...
        <meta name="twitter:title" content="Stable Diffusion Web Review: AI Image Generator | SiteOptz" />
