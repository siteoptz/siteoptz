...
export default function SeRankingVsAdcreativeAi({ tool1, tool2 }: ComparisonPageProps) {
  ...
  return {
    props: {
      tool1: {
        ...
        description: "Comprehensive SEO platform offering keyword research, rank tracking, and site audits with flexible monitoring capabilities."
      },
      tool2: {
        name: "AdCreative.ai",
        slug: "adcreative-ai",
