...
// Static comparison page for Google Search vs AdCreative.ai
const ComparisonPage: React.FC = () => {
  ...
  "name": "Google Search",
  "slug": "google-search",
  "logo": "/images/tools/google-ai-mode-logo.svg",
  ...
  "overview": {
    ...
    "use_cases": [
      ...
      "Getting quick answers and suggestions",
      "Learning about Google products and AI"
    ],
    "long_description": "Google Search is a productivity platform designed to streamline workflows and enhance productivity through AI automation. This comprehensive solution helps businesses optimize operations while maintaining competitive advantages in their respective markets."
  },
  "features": [
    "AI-powered suggestions and insights",
    "Personalized content based on user interests",
    "Playful prompts ('I'm Feeling Curious', 'Hungry', etc.)",
    "Information on Google devices and AI initiatives",
    "Links to Google's advertising and business services",
    "Privacy and Terms information",
    "Search settings and history management"
  ],
  "pricing": [
    {
      "tier": "Free",
  ...
  "pros": [
    "Provides a more engaging and personalized search experience",
    "Encourages discovery of new information and topics",
    "Offers a glimpse into Google's AI advancements and product lineup",
    "Easy access to core Google services and information"
  ],
  "cons": [
    "AI mode can sometimes produce inappropriate predictions.",
    "Limited customization options for AI mode."
  ],
  "benchmarks": {
    "speed": 9,
    "accuracy": 9,
  ...
  "last_updated": "2025-08-21T18:15:20.845Z",
  "rating": 4.5,
  "review_count": 1000000000,
  "free_trial": false,
  "seo": {
    "title": "Google Search Review 2025 - Productivity AI Tool | SiteOptz",
    "description": "Google Search offers an 'AI Mode' that provides personalized suggestions and insights based on user interests and trendi. Compare pricing, features, pros & cons. Expert Productivity AI tool review.",
    "keywords": [
      "google search",
    ...
    "canonical_url": "https://siteoptz.ai/tools/google-search"
  },
  "meta": {
    "description": "Google Search review: Complete analysis of features, pricing (free plan available), pros, cons & alternatives. Expert guide for productivity in 2025.",
    "keywords": "google search review, google search features, google search pricing, google search alternatives, google search vs"
  },
  "related_tools": [],
  "logo_url": "/images/tools/google-ai-mode-logo.svg",
  "enhanced_features": [
    {
      "name": "AI-powered suggestions and insights",
      "seoDescription": "Google Search's AI-powered suggestions and insights provides advanced automation capabilities that improve efficiency and reduce manual overhead.",
      "benefits": [
        "Streamlines ai-powered suggestions and insights",
        "Improves accuracy",
        "Saves time"
      ]
    },
    {
      "name": "Personalized content based on user interests",
      "seoDescription": "Google Search's Personalized content based on user interests provides advanced automation capabilities that improve efficiency and reduce manual overhead.",
      "benefits": [
        "Streamlines personalized content based on user interests",
        "Improves accuracy",
        "Saves time"
      ]
    },
    {
      "name": "Playful prompts ('I'm Feeling Curious', 'Hungry', etc.)",
      "seoDescription": "Google Search's Playful prompts ('I'm Feeling Curious', 'Hungry', etc.) provides advanced automation capabilities that improve efficiency and reduce manual overhead.",
      "benefits": [
        "Streamlines playful prompts ('i'm feeling curious', 'hungry', etc.)",
        "Improves accuracy",
        "Saves time"
      ]
    }
  ...
  "use_cases": [
    {
      ...
      "description": "Organizations use Google Search to implement productivity strategies that improve efficiency and reduce operational costs.",
    ...
    },
    {
      ...
      "description": "Google Search helps teams automate workflows and optimize processes for better productivity and scalability.",
  ...
  "faq": [
    {
      "question": "What is Google Search and how does it work?",
      "answer": "Google Search is a productivity platform that uses AI to automate workflows and optimize processes for better business outcomes."
    },
    {
      "question": "How much does Google Search cost?",
      "answer": "Google Search offers flexible pricing plans designed for different business sizes, from startups to enterprise organizations."
    },
    {
      "question": "What are the main benefits of using Google Search?",
  ...
  "benefits_roi": {
    ...
    "business_impact": "Google Search delivers measurable improvements within the first quarter, helping businesses achieve ROI through efficiency gains and cost reductions."
  }
};
  const tool2 = {
  "id": "adcreative-ai",
