...
export default function ContentstudioVsCoschedule({ tool1, tool2 }: ComparisonPageProps) {
  ...
  return {
    props: {
      tool1: {
        ...
        description: "Content marketing-focused social media tool with content curation and automation features."
      },
      tool2: {
        name: "Coschedule",
        slug: "coschedule",
        category: "AI Tools",
        description: "Coschedule offers advanced capabilities for modern business needs."
      }
    },
    revalidate: 86400
  };
