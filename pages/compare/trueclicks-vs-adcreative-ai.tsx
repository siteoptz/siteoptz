...
// Static comparison page for TrueClicks vs AdCreative.ai
const ComparisonPage: React.FC = () => {
  ...
  "overview": {
    ...
    "long_description": "TrueClicks is a paid search & ppc platform designed to streamline workflows and enhance productivity through AI automation. This comprehensive solution helps businesses optimize operations while maintaining competitive advantages in their respective markets."
  },
  "features": [
  ...
  "review_count": 180,
  "category": "Paid Search & PPC",
  "logo_url": "/images/tools/trueclicks-logo.svg",
  "meta": {
    "description": "TrueClicks detailed review. Paid Search & PPC features, from $99/month pricing, user feedback & comparisons. Make informed decisions with our expert analysis.",
    "keywords": "trueclicks review, trueclicks features, trueclicks pricing, trueclicks alternatives, trueclicks vs"
  },
  "enhanced_features": [
    {
      "name": "Real-time fraud detection",
      "seoDescription": "TrueClicks's Real-time fraud detection provides advanced automation capabilities that improve efficiency and reduce manual overhead.",
      "benefits": [
        "Streamlines real-time fraud detection",
        "Improves accuracy",
        "Saves time"
      ]
    },
    {
      "name": "Invalid traffic blocking",
      "seoDescription": "TrueClicks's Invalid traffic blocking provides advanced automation capabilities that improve efficiency and reduce manual overhead.",
      "benefits": [
        "Streamlines invalid traffic blocking",
        "Improves accuracy",
        "Saves time"
      ]
    },
    {
      "name": "Bot detection algorithms",
      "seoDescription": "TrueClicks's Bot detection algorithms provides advanced automation capabilities that improve efficiency and reduce manual overhead.",
      "benefits": [
        "Streamlines bot detection algorithms",
        "Improves accuracy",
        "Saves time"
      ]
    }
  ...
  "use_cases": [
    {
      ...
      "description": "Organizations use TrueClicks to implement paid search & ppc strategies that improve efficiency and reduce operational costs.",
    ...
    },
    {
      ...
      "description": "TrueClicks helps teams automate workflows and optimize processes for better productivity and scalability.",
  ...
  "faq": [
    {
      "question": "What is TrueClicks and how does it work?",
      "answer": "TrueClicks is a paid search & ppc platform that uses AI to automate workflows and optimize processes for better business outcomes."
    },
    {
      "question": "How much does TrueClicks cost?",
      "answer": "TrueClicks offers flexible pricing plans designed for different business sizes, from startups to enterprise organizations."
    },
    {
      "question": "What are the main benefits of using TrueClicks?",
  ...
  "benefits_roi": {
    ...
    "business_impact": "TrueClicks delivers measurable improvements within the first quarter, helping businesses achieve ROI through efficiency gains and cost reductions."
  }
};
  const tool2 = {
  "id": "adcreative-ai",
