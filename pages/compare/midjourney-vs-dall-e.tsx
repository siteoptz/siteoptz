...
export default function MidjourneyVsDallEComparison() {
  return (
    <>
      <Head>
        <title>Midjourney vs Dall E: Complete Comparison | SiteOptz</title>
        <meta 
          name="description" 
          content="Compare Midjourney vs Dall E. Feature-by-feature analysis, pricing comparison, and expert recommendations to help you choose the right tool."
        />
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <div className="flex justify-center items-center space-x-8 mb-8">
              ...
              <div className="text-center">
                <ToolLogo toolName="Dall E" size="xl" className="mx-auto mb-4" />
                <h2 className="text-xl font-semibold text-gray-900">Dall E</h2>
              </div>
            </div>
            
            <p className="text-center text-gray-600 max-w-3xl mx-auto">
              Comprehensive comparison of Midjourney and Dall E to help you make the right choice for your business needs.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Choose Dall E if:</h4>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
