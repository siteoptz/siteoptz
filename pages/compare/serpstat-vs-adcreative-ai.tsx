...
export default function SerpstatVsAdcreativeAi({ tool1, tool2 }: ComparisonPageProps) {
  ...
  return {
    props: {
      tool1: {
        ...
        description: "SEO platform specialized in handling bulk data queries and mass keyword tracking for large-scale SEO operations."
      },
      tool2: {
        name: "AdCreative.ai",
        slug: "adcreative-ai",
