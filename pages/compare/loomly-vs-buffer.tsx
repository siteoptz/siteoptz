...
export default function LoomlyVsBufferComparison() {
  return (
    <>
      <Head>
        <title>Loomly vs Buffer: Complete Comparison | SiteOptz</title>
        <meta 
          name="description" 
          content="Compare Loomly vs Buffer. Feature-by-feature analysis, pricing comparison, and expert recommendations to help you choose the right tool."
        />
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <p className="text-center text-gray-600 max-w-3xl mx-auto">
              Comprehensive comparison of Loomly and Buffer to help you make the right choice for your business needs.
            </p>
          </div>
