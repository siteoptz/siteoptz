...
export default function CopilotAudioExpressionVsAdcreativeAi({ tool1, tool2 }: ComparisonPageProps) {
...
export const getStaticProps: GetStaticProps = async () => {
  return {
    props: {
      tool1: {
        name: "Copilot Audio Expression",
        slug: "copilot-audio-expression",
        category: "undefined",
