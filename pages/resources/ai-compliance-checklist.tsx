...
export default function AiComplianceChecklist() {
  const [modalState, setModalState] = useState<{
    ...
    source: 'ai-compliance-checklist_page'
  });

  const openModal = (resourceType: 'playbook' | 'framework' | 'both', source: string = 'ai-compliance-checklist_page') => {
    setModalState({
      isOpen: true,
      resourceType,
      source
  ...
  return (
    <>
      <Head>
        <title>AI Compliance Checklist - Expert Guide & Resources | SiteOptz</title>
        <meta 
          name="description" 
          content="Comprehensive checklist covering AI ethics, data privacy, regulatory compliance, and risk management frameworks. Download expert resources, templates, and implementation guides." 
        />
        <link rel="canonical" href="https://siteoptz.ai/resources/ai-compliance-checklist" />
        
        <meta property="og:title" content="AI Compliance Checklist | SiteOptz" />
        <meta property="og:description" content="Comprehensive checklist covering AI ethics, data privacy, regulatory compliance, and risk management frameworks." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/resources/ai-compliance-checklist" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Comprehensive checklist covering AI ethics, data privacy, regulatory compliance, and risk management frameworks.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-2xl p-8 border border-cyan-400 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Get comprehensive templates, frameworks, and implementation guides for ai compliance checklist.
                </p>
                <button
                  onClick={() => openModal('framework', 'ai-compliance-checklist_hero')}
