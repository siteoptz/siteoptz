...
export default function DataDrivenMarketing() {
  const [modalState, setModalState] = useState<{
    ...
    source: 'data-driven-marketing_page'
  });

  const openModal = (resourceType: 'playbook' | 'framework' | 'both', source: string = 'data-driven-marketing_page') => {
    setModalState({
      isOpen: true,
      resourceType,
      source
  ...
  return (
    <>
      <Head>
        <title>Data-Driven Marketing Strategy - Expert Guide & Resources | SiteOptz</title>
        <meta 
          name="description" 
          content="Transform your marketing with AI-powered analytics, personalization, and automated campaign optimization. Download expert resources, templates, and implementation guides." 
        />
        <link rel="canonical" href="https://siteoptz.ai/resources/data-driven-marketing" />
        
        <meta property="og:title" content="Data-Driven Marketing Strategy | SiteOptz" />
        <meta property="og:description" content="Transform your marketing with AI-powered analytics, personalization, and automated campaign optimization." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/resources/data-driven-marketing" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Transform your marketing with AI-powered analytics, personalization, and automated campaign optimization.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-2xl p-8 border border-cyan-400 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Get comprehensive templates, frameworks, and implementation guides for data-driven marketing strategy.
                </p>
                <button
                  onClick={() => openModal('framework', 'data-driven-marketing_hero')}
