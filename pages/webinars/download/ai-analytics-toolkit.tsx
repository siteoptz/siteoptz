...
export default function AiAnalyticsToolkitDownload() {
  const [modalState, setModalState] = useState<{
    ...
    source: 'ai-analytics-toolkit_download'
  });

  const openModal = (resourceType: 'playbook' | 'framework' | 'both', source: string = 'ai-analytics-toolkit_download') => {
    setModalState({
      isOpen: true,
      resourceType,
      source
  ...
  return (
    <>
      <Head>
        <title>AI Analytics Toolkit - Webinar Resources Download | SiteOptz</title>
        <meta 
          name="description" 
          content="Complete toolkit for implementing AI-powered business intelligence and data analysis solutions. Download presentation slides, templates, and additional resources from our expert webinar." 
        />
        <link rel="canonical" href="https://siteoptz.ai/webinars/download/ai-analytics-toolkit" />
        
        <meta property="og:title" content="AI Analytics Toolkit Resources | SiteOptz" />
        <meta property="og:description" content="Complete toolkit for implementing AI-powered business intelligence and data analysis solutions." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/webinars/download/ai-analytics-toolkit" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Complete toolkit for implementing AI-powered business intelligence and data analysis solutions.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-2xl p-8 border border-blue-400/20 mb-12">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <button
                    onClick={() => openModal('framework', 'ai-analytics-toolkit_main')}
