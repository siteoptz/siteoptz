...
export default function AiContentMarketingResourcesDownload() {
  const [modalState, setModalState] = useState<{
    ...
    source: 'ai-content-marketing-resources_download'
  });

  const openModal = (resourceType: 'playbook' | 'framework' | 'both', source: string = 'ai-content-marketing-resources_download') => {
    setModalState({
      isOpen: true,
      resourceType,
      source
  ...
  return (
    <>
      <Head>
        <title>AI Content Marketing Resources - Webinar Resources Download | SiteOptz</title>
        <meta 
          name="description" 
          content="Templates, workflows, and tools for leveraging AI in content creation and marketing automation. Download presentation slides, templates, and additional resources from our expert webinar." 
        />
        <link rel="canonical" href="https://siteoptz.ai/webinars/download/ai-content-marketing-resources" />
        
        <meta property="og:title" content="AI Content Marketing Resources Resources | SiteOptz" />
        <meta property="og:description" content="Templates, workflows, and tools for leveraging AI in content creation and marketing automation." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/webinars/download/ai-content-marketing-resources" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                AI Content Marketing Resources
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Templates, workflows, and tools for leveraging AI in content creation and marketing automation.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-2xl p-8 border border-blue-400/20 mb-12">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <button
                    onClick={() => openModal('framework', 'ai-content-marketing-resources_main')}
