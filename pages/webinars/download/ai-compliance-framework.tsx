...
export default function AiComplianceFrameworkDownload() {
  const [modalState, setModalState] = useState<{
    ...
    source: 'ai-compliance-framework_download'
  });

  const openModal = (resourceType: 'playbook' | 'framework' | 'both', source: string = 'ai-compliance-framework_download') => {
    setModalState({
      isOpen: true,
      resourceType,
      source
  ...
  return (
    <>
      <Head>
        <title>AI Compliance Framework - Webinar Resources Download | SiteOptz</title>
        <meta 
          name="description" 
          content="Framework for ensuring AI implementations meet regulatory requirements and ethical standards. Download presentation slides, templates, and additional resources from our expert webinar." 
        />
        <link rel="canonical" href="https://siteoptz.ai/webinars/download/ai-compliance-framework" />
        
        <meta property="og:title" content="AI Compliance Framework Resources | SiteOptz" />
        <meta property="og:description" content="Framework for ensuring AI implementations meet regulatory requirements and ethical standards." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/webinars/download/ai-compliance-framework" />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Framework for ensuring AI implementations meet regulatory requirements and ethical standards.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-2xl p-8 border border-blue-400/20 mb-12">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <button
                    onClick={() => openModal('framework', 'ai-compliance-framework_main')}
