...
export default function AiEthicsComplianceWebinar() {
  const title = "Ai Ethics Compliance - Watch Webinar | SiteOptz";
  const description = "Watch our ai ethics compliance webinar. Expert insights, live demonstrations, and Q&A on AI tools and implementation strategies.";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="ai, ethics, compliance, webinar, AI training, live session" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`https://siteoptz.ai/webinars/watch/ai-ethics-compliance`} />
      </Head>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <nav className="mb-8">
            <ol className="flex items-center space-x-2 text-gray-400 text-sm">
              ...
              <li><span className="mx-2">/</span></li>
              <li className="text-cyan-400">Ai Ethics Compliance</li>
            </ol>
          </nav>
          ...
          <div className="bg-black/50 border border-gray-800 rounded-2xl p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              This ai ethics compliance webinar will feature expert insights, live tool demonstrations, 
