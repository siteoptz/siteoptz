      ...
      <Layout className="bg-gradient-to-b from-blue-50 via-white to-purple-50">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600">We&apos;re fully compliant with children&apos;s online privacy laws</p>
                </div>
                <div>
                  <h3 className="font-bold mb-3 flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600" />
                  ...
                  <p className="text-gray-600">All content is reviewed and filtered for safety</p>
                </div>
                <div>
                  <h3 className="font-bold mb-3 flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600" />
                  ...
                  <p className="text-gray-600">You control what your child can access and share</p>
                </div>
                <div>
                  <h3 className="font-bold mb-3 flex items-center gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600" />
                  ...
                  <p className="text-gray-600">No personal data is shared publicly</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              <h2 className="text-2xl font-bold mb-6">Parent Dashboard Features</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <BarChart className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold mb-1">Progress Tracking</h3>
                    <p className="text-gray-600">See what your child is learning and how they&apos;re progressing</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Users className="w-6 h-6 text-purple-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold mb-1">Project Visibility</h3>
                    <p className="text-gray-600">Review projects your child creates before they share publicly</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Set learning goals and monitor screen time</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get email updates on your child&apos;s learning journey</p>
                  </div>
                </div>
              </div>
            </div>
