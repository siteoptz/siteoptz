...
export default function WhatIsAIPage() {
  ...
  const sections = [
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white border-2 border-purple-200 rounded-xl p-6">
              ...
              <h4 className="font-bold text-lg mb-2">Regular Computer</h4>
            ...
            <div className="bg-white border-2 border-blue-200 rounded-xl p-6">
              ...
              <h4 className="font-bold text-lg mb-2">AI Computer</h4>
              <p className="text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h3 className="text-2xl font-bold mb-6">AI is Already in Your Life!</h3>
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-6 border-2 border-green-200">
              <div className="flex items-start gap-4">
                <CheckCircle className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" />
                <div>
                  <h4 className="font-bold text-lg mb-2">🎮 Video Games</h4>
                  <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-blue-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">📱 Your Phone</h4>
                  <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-purple-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">🖼️ Photo Apps</h4>
                  <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 border-2 border-yellow-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg mb-2">🤖 ChatGPT & Image Generators</h4>
                  <p className="text-gray-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <h3 className="text-2xl font-bold mb-6">How Does AI Learn?</h3>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6 text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Awesome Job! 🎉</h2>
          ...
          <div className="bg-white rounded-xl p-8 max-w-2xl mx-auto">
            <ul className="space-y-4 text-left">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700"><strong>AI</strong> stands for Artificial Intelligence</span>
              </li>
              <li className="flex items-start gap-3">
                <Brain className="w-6 h-6 text-blue-600 flex-shrink-0" />
                <span className="text-gray-700">AI is like a smart computer that can learn and make decisions</span>
              </li>
              <li className="flex items-start gap-3">
                <Bot className="w-6 h-6 text-green-600 flex-shrink-0" />
                <span className="text-gray-700">AI is already all around you - in games, phones, and apps!</span>
              </li>
              <li className="flex items-start gap-3">
                <Lightbulb className="w-6 h-6 text-yellow-600 flex-shrink-0" />
                <span className="text-gray-700">AI learns by looking at lots of examples, just like you do!</span>
              </li>
            </ul>
          </div>
