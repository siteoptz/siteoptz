...
export default function MarketingAutomationAiToolsTranscript() {
  const title = "Marketing Automation Ai Tools - Podcast Transcript | SiteOptz";
  const description = "Full transcript of our marketing automation ai tools podcast episode. Expert insights and actionable strategies for AI implementation.";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="marketing, automation, ai, tools, podcast, transcript, AI insights" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={`https://siteoptz.ai/podcasts/transcripts/marketing-automation-ai-tools`} />
      </Head>
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <nav className="mb-8">
            <ol className="flex items-center space-x-2 text-gray-400 text-sm">
              ...
              <li><span className="mx-2">/</span></li>
              <li className="text-cyan-400">Marketing Automation Ai Tools</li>
            </ol>
          </nav>
          ...
          <div className="bg-black/50 border border-gray-800 rounded-2xl p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              We&apos;re preparing the full transcript for this marketing automation ai tools episode. 
