...
export default function HealthcareAutomationCaseStudy() {
  const caseStudyData = {
    ...
    timeline: "6 months",
    challenge: "A healthcare provider automated patient intake and scheduling, reducing wait times by 40% and improving patient satisfaction.",
  ...
  return (
    <>
      <Head>
        <title>Healthcare Process Automation - AI Implementation Case Study | SiteOptz</title>
        <meta 
          name="description" 
          content="A healthcare provider automated patient intake and scheduling, reducing wait times by 40% and improving patient satisfaction. See detailed results, ROI data, and implementation strategies." 
        />
        <link rel="canonical" href="https://siteoptz.ai/case-studies/healthcare-automation" />
        
        <meta property="og:title" content="Healthcare Process Automation | SiteOptz" />
        <meta property="og:description" content="A healthcare provider automated patient intake and scheduling, reducing wait times by 40% and improving patient satisfaction." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/case-studies/healthcare-automation" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-gray-400 text-sm">Healthcare • 6 months</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Healthcare Process Automation
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                A healthcare provider automated patient intake and scheduling, reducing wait times by 40% and improving patient satisfaction.
              </p>
            </div>
