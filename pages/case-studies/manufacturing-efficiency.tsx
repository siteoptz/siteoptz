...
export default function ManufacturingEfficiencyCaseStudy() {
  const caseStudyData = {
    title: "Manufacturing AI Efficiency",
    industry: "Manufacturing",
    companySize: "500-1000 employees",
    timeline: "6 months",
    challenge: "Smart factory implementation reduced production costs by 25% while improving quality control through predictive maintenance.",
  ...
  return (
    <>
      <Head>
        <title>Manufacturing AI Efficiency - AI Implementation Case Study | SiteOptz</title>
        <meta 
          name="description" 
          content="Smart factory implementation reduced production costs by 25% while improving quality control through predictive maintenance. See detailed results, ROI data, and implementation strategies." 
        />
        <link rel="canonical" href="https://siteoptz.ai/case-studies/manufacturing-efficiency" />
        
        <meta property="og:title" content="Manufacturing AI Efficiency | SiteOptz" />
        <meta property="og:description" content="Smart factory implementation reduced production costs by 25% while improving quality control through predictive maintenance." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/case-studies/manufacturing-efficiency" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-gray-400 text-sm">Manufacturing • 6 months</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Manufacturing AI Efficiency
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Smart factory implementation reduced production costs by 25% while improving quality control through predictive maintenance.
              </p>
            </div>
