...
export default function HrAiSuccessCaseStudy() {
  const caseStudyData = {
    title: "HR AI Transformation Success",
    industry: "Human Resources",
    companySize: "500-1000 employees",
    timeline: "6 months",
    challenge: "How a mid-size company revolutionized their HR operations with AI, reducing hiring time by 60% and improving employee satisfaction.",
  ...
  return (
    <>
      <Head>
        <title>HR AI Transformation Success - AI Implementation Case Study | SiteOptz</title>
        <meta 
          name="description" 
          content="How a mid-size company revolutionized their HR operations with AI, reducing hiring time by 60% and improving employee satisfaction. See detailed results, ROI data, and implementation strategies." 
        />
        <link rel="canonical" href="https://siteoptz.ai/case-studies/hr-ai-success" />
        
        <meta property="og:title" content="HR AI Transformation Success | SiteOptz" />
        <meta property="og:description" content="How a mid-size company revolutionized their HR operations with AI, reducing hiring time by 60% and improving employee satisfaction." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/case-studies/hr-ai-success" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-gray-400 text-sm">Human Resources • 6 months</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                HR AI Transformation Success
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                How a mid-size company revolutionized their HR operations with AI, reducing hiring time by 60% and improving employee satisfaction.
              </p>
            </div>
