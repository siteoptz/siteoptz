...
export default function EcommerceAiCaseStudy() {
  const caseStudyData = {
    ...
    timeline: "6 months",
    challenge: "How an online retailer increased conversion rates by 150% using AI-powered personalization and recommendation engines.",
  ...
  return (
    <>
      <Head>
        <title>E-commerce AI Personalization - AI Implementation Case Study | SiteOptz</title>
        <meta 
          name="description" 
          content="How an online retailer increased conversion rates by 150% using AI-powered personalization and recommendation engines. See detailed results, ROI data, and implementation strategies." 
        />
        <link rel="canonical" href="https://siteoptz.ai/case-studies/ecommerce-ai" />
        
        <meta property="og:title" content="E-commerce AI Personalization | SiteOptz" />
        <meta property="og:description" content="How an online retailer increased conversion rates by 150% using AI-powered personalization and recommendation engines." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/case-studies/ecommerce-ai" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-4">
                ...
                <span className="text-gray-400 text-sm">E-commerce • 6 months</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                E-commerce AI Personalization
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                How an online retailer increased conversion rates by 150% using AI-powered personalization and recommendation engines.
              </p>
            </div>
