...
export default function EnterpriseAiRoi2024() {
  const [modalState, setModalState] = useState<{
    ...
    source: 'enterprise-ai-roi-2024_report'
  });

  const openModal = (resourceType: 'playbook' | 'framework' | 'both', source: string = 'enterprise-ai-roi-2024_report') => {
    setModalState({
      isOpen: true,
      resourceType,
      source
  ...
  return (
    <>
      <Head>
        <title>Enterprise AI ROI Report 2024 - Comprehensive Industry Report | SiteOptz</title>
        <meta 
          name="description" 
          content="Detailed ROI analysis from enterprise AI implementations, including cost breakdowns and performance metrics. Download the complete report with data, insights, and industry benchmarks." 
        />
        <link rel="canonical" href="https://siteoptz.ai/reports/enterprise-ai-roi-2024" />
        
        <meta property="og:title" content="Enterprise AI ROI Report 2024 | SiteOptz" />
        <meta property="og:description" content="Detailed ROI analysis from enterprise AI implementations, including cost breakdowns and performance metrics." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://siteoptz.ai/reports/enterprise-ai-roi-2024" />
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Enterprise AI ROI Report 2024
              </h1>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Detailed ROI analysis from enterprise AI implementations, including cost breakdowns and performance metrics.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-600/10 to-blue-600/10 rounded-2xl p-8 border border-purple-400/20 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Get the full enterprise ai roi report 2024 with detailed analysis, charts, benchmarks, and actionable insights.
                </p>
                <button
                  onClick={() => openModal('framework', 'enterprise-ai-roi-2024_hero')}
