    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black py-8 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          {/* Header */}
          <div className="bg-black rounded-lg shadow-sm border border-gray-800 p-8 mb-8">
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center bg-green-900/30 px-3 py-1 rounded-full">
                ...
                <span className="text-sm text-green-400">v1.0 Stable</span>
              </div>
              <div className="flex items-center bg-blue-900/30 px-3 py-1 rounded-full">
                <span className="text-sm text-blue-400">REST API</span>
              </div>
              <div className="flex items-center bg-purple-900/30 px-3 py-1 rounded-full">
                <span className="text-sm text-purple-400">Rate Limited</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-black rounded-lg shadow-sm border border-gray-800 p-6 sticky top-8">
                <h3 className="font-semibold text-white mb-4">Documentation</h3>
                <nav className="space-y-2">
                  <a href="#getting-started" className="block text-sm text-gray-300 hover:text-cyan-400">Getting Started</a>
                  <a href="#authentication" className="block text-sm text-gray-300 hover:text-cyan-400">Authentication</a>
                  <a href="#rate-limiting" className="block text-sm text-gray-300 hover:text-cyan-400">Rate Limiting</a>
                  <a href="#endpoints" className="block text-sm text-gray-300 hover:text-cyan-400">API Endpoints</a>
                  <a href="#tools-list" className="block text-sm text-gray-300 hover:text-cyan-400 ml-4">List Tools</a>
                  <a href="#tool-detail" className="block text-sm text-gray-300 hover:text-cyan-400 ml-4">Tool Details</a>
                  <a href="#categories" className="block text-sm text-gray-300 hover:text-cyan-400 ml-4">Categories</a>
                  <a href="#compare" className="block text-sm text-gray-300 hover:text-cyan-400 ml-4">Compare Tools</a>
                  <a href="#examples" className="block text-sm text-gray-300 hover:text-cyan-400">Code Examples</a>
                  <a href="#widgets" className="block text-sm text-gray-300 hover:text-cyan-400">Embed Widgets</a>
                </nav>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              {/* Getting Started */}
              <section id="getting-started" className="bg-black rounded-lg shadow-sm border border-gray-800 p-8">
                ...
                <div className="bg-gray-900 rounded-lg p-4 mb-6">
                  ...
                  <code className="text-sm text-cyan-400 bg-black px-2 py-1 rounded">
              ...
              {/* Rate Limiting */}
              <section id="rate-limiting" className="bg-black rounded-lg shadow-sm border border-gray-800 p-8">
                ...
                <div className="bg-gray-900 rounded-lg p-4">
                  <h4 className="font-semibold text-white mb-2">Response Headers</h4>
...
X-RateLimit-Window: 60s`}
              ...
              {/* Endpoints */}
              <section id="endpoints" className="bg-black rounded-lg shadow-sm border border-gray-800 p-8">
                <h2 className="text-2xl font-bold text-white mb-6">API Endpoints</h2>

                {/* List Tools */}
                <div id="tools-list" className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4">GET /tools</h3>
                  <p className="text-gray-300 mb-4">Retrieve a list of AI tools with filtering and pagination.</p>
                    ...
                    <table className="min-w-full text-sm">
                      <thead>
                        <tr className="border-b border-gray-700">
                          <th className="text-left py-2 px-3 font-medium text-white">Parameter</th>
                          <th className="text-left py-2 px-3 font-medium text-white">Type</th>
                          <th className="text-left py-2 px-3 font-medium text-white">Description</th>
                        </tr>
                      </thead>
...
curl "https://siteoptz.ai/api/v1/tools?category=seo&limit=5"`}
                ...
                <div id="tool-detail" className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4">GET /tools/&#123;slug&#125;</h3>
                  <p className="text-gray-300 mb-4">Get detailed information about a specific AI tool.</p>
...
curl "https://siteoptz.ai/api/v1/tools/chatgpt"`}
                ...
                <div id="categories" className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4">GET /categories</h3>
                  <p className="text-gray-300 mb-4">Get all available tool categories with optional counts.</p>
...
curl "https://siteoptz.ai/api/v1/categories?include_count=true"`}
                ...
                <div id="compare" className="mb-8">
                  <h3 className="text-xl font-semibold text-white mb-4">POST /tools/compare</h3>
                  <p className="text-gray-300 mb-4">Compare multiple AI tools side by side.</p>
...

{
  ...
  "fields": ["name", "pricing", "features"]
              ...
              {/* Code Examples */}
              <section id="examples" className="bg-black rounded-lg shadow-sm border border-gray-800 p-8">
...
search_results = search_response.json()`}
              ...
              {/* Embed Widgets */}
              <section id="widgets" className="bg-black rounded-lg shadow-sm border border-gray-800 p-8">
                <h2 className="text-2xl font-bold text-white mb-6">Embeddable Widgets</h2>
                <p className="text-gray-300 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="border border-gray-800 rounded-lg p-4">
                    <h4 className="font-semibold text-white mb-2">Tool List Widget</h4>
                    <p className="text-gray-300 text-sm mb-3">Display a customizable list of AI tools</p>
                  ...
                  <div className="border border-gray-800 rounded-lg p-4">
                    <h4 className="font-semibold text-white mb-2">Search Widget</h4>
                    <p className="text-gray-300 text-sm mb-3">Add AI tool search to your site</p>
                    <div className="bg-gray-800 rounded p-2 text-xs text-gray-300">
              ...
              {/* Support */}
              <section className="bg-gradient-to-r from-blue-900/20 to-indigo-900/20 rounded-lg p-8 border border-blue-800">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a 
                    ...
                    className="border border-cyan-600 text-cyan-400 px-6 py-2 rounded-lg hover:bg-gray-800 transition-colors"
                  >
                    Email Us
                  </a>
                </div>
