...
const categoryDescriptions: { [key: string]: string } = {
  ...
  'Development': 'AI coding assistants and development automation tools',
  'Visual Content': 'Image and video generation, editing, and enhancement tools',
  ...
  'Research': 'AI tools for research, education, and knowledge discovery',
