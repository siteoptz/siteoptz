...
const PricingPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Pricing Plans - SiteOptz AI Tools Platform</title>
        <meta name="description" content="Choose the perfect plan for your business. Unlock unlimited AI tool comparisons, expert consultations, and implementation support. Transform your business with AI." />
        <meta name="keywords" content="ai tools pricing, subscription plans, ai consulting, business transformation, ai implementation" />
        <link rel="canonical" href="https://siteoptz.ai/pricing" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Pricing Plans | SiteOptz" />
        <meta property="og:description" content="Choose the perfect plan for your AI transformation journey. From free tools to enterprise solutions." />
        ...
        <section className="relative py-20 px-6">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Choose Your
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600"> AI Transformation</span> Plan
            </h1>
