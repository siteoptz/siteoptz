...
export default function SocialPilotReviewPage() {
  ...
  const reviewSchema = {
    ...
    "reviewBody": "Comprehensive SocialPilot review covering features, pricing, and alternatives.",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gray-900/10 rounded-full blur-3xl "></div>
...
- Side-by-side comparisons with top alternatives</p>
        ...
        {/* Expert CTA Section */}
        <ExpertCTASection toolName="SocialPilot" />
