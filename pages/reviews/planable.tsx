...
export default function PlanableReview() {
  return (
    <>
      <Head>
        <title>Planable Review: Features, Pricing & Alternatives | SiteOptz</title>
        <meta 
          name="description" 
          content="Comprehensive Planable review covering features, pricing, pros, cons, and alternatives. Get expert insights on this social media tool."
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            ...
            __html: JSON.stringify({
                      ...
                      "description": "Planable is a comprehensive AI tool designed to enhance productivity and efficiency for businesses and professionals.",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            ...
            __html: JSON.stringify({
                      ...
                      "reviewBody": "Comprehensive Planable review covering features, pricing, and alternatives.",
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="bg-black border border-gray-800 rounded-lg p-8 mb-8">
            <div className="flex items-center mb-6">
              <ToolLogo toolName="Planable" size="lg" className="mr-4" />
              <div>
                <h1 className="text-3xl font-bold text-white mb-2">
                  Planable Review
                </h1>
                <p className="text-gray-400">Social Media Tool</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black border border-gray-800 rounded-lg p-8 mb-8">
            ...
            <p className="text-gray-300 mb-6">
              Planable is a powerful social media tool that helps businesses optimize their workflows 
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-8 text-center">
            ...
            <p className="mb-6 text-blue-100">
              Get expert guidance on implementing Planable and other social media tools for your business.
            </p>
            <Link 
              href="/contact" 
