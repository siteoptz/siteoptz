...
export default function OtteraiReview() {
  return (
    <>
      <Head>
        <title>Otter.ai Review: Features, Pricing & Alternatives | SiteOptz</title>
        <meta 
          name="description" 
          content="Comprehensive Otter.ai review covering features, pricing, pros, cons, and alternatives. Get expert insights on this productivity tool."
        />
        ...
        <link rel="canonical" href="https://www.siteoptz.ai/reviews/otter-ai" />
      </Head>
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            <div className="flex items-center mb-6">
              <ToolLogo toolName="Otter.ai" size="lg" className="mr-4" />
              <div>
                <h1 className="text-3xl font-bold text-gray-900 mb-2">
                  Otter.ai Review
                </h1>
                <p className="text-gray-600">Productivity Tool</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <p className="text-gray-700 mb-6">
              Otter.ai is a powerful productivity tool that helps businesses optimize their workflows 
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-8 text-center">
            <h3 className="text-2xl font-bold mb-4">Ready to Optimize Your Productivity?</h3>
            <p className="mb-6 text-blue-100">
              Get expert guidance on implementing Otter.ai and other productivity tools for your business.
            </p>
            <Link 
              href="/contact" 
