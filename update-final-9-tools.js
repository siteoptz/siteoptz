...
// The final 9 tools that are now in the database
const finalTools = [
...
// Main function to update the final 9 tools
async function updateFinal9Tools() {
  console.log('🚀 Starting update of final 9 tools with full SEO structure...\n');
  ...
  for (const toolSlug of finalTools) {
    console.log(`\nProcessing: ${toolSlug}`);
  ...
  console.log(`📁 Total processed: ${finalTools.length} tools`);
}

if (require.main === module) {
  updateFinal9Tools().catch(console.error);
}

module.exports = { generateFullSEOComponent, updateFinal9Tools };